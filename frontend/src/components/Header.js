    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if(response.status === 201) {
                enqueueSnakeBar("video uploaded successfully", {variant: "success"});
            }
            handleModalClose();

        } catch(err) {
            if(err)
                enqueueSnakeBar(`${err.message}, something went wrong!`, {variant: "error"});
        }
    }
        ...
        <Box sx = {{
            ...
            >
                ...
                <DialogActions className="upload-btn-groups">
                    ...
                    <Button id= "upload-btn-cancel" variant= "contained" onClick= {handleModalClose} autoFocus>Cancel</Button>
                </DialogActions>
