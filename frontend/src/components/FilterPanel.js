...
import { ReleaseDate, AllGenreParameter } from "../constants/constant";
    ...
    return (
        <Box sx= {{
            ...
            <Box sx= {{
                ...
                </button>
                {
                    genreList && genreList.map(item => {
                        return (
                            <button
                                className= {item.selected ? "genre-btn-selected" : "genre-btn"}
            ...
            <Box sx= {{
                ...
                {
                    ratingList && ratingList.slice(0, ratingList.length-1).map(item => {
                        return (
                            <button
